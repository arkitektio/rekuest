...
:meth:`~rekuest.structures.registry.StructureRegistry.register_as_structure`
call.
...
from rekuest.api.schema import AssignWidgetInput, ReturnWidgetInput
from rekuest.structures.convert import cls_to_identifier
