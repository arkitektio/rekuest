...
from rekuest.agents.transport.types import (
    HandshakeParams,
    HandshakeProvider,
    TransportHost,
)
...
class AgentTransport(KoiledModel):
    ...
    :data:`~rekuest.messages.ToAgentMessage` /
    :data:`~rekuest.messages.FromAgentMessage` model instances.

    The contract is the members below, stated canonically as a Protocol in
    :mod:`rekuest.agents.transport.types`:
